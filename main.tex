...
\begin{itemize}
    ...
    \item geolocator - biblioteka która pozwala na komunikacje z serwisem odpowiedzialnym za lokallizację. W projekcie jest wykorzystywana w celu sprawdzenia czy lokazacja jest ciągle włączona na użądzeniu. 
    ...
    \item loading\_animation\_widget - biblioteka zawierajaca animacje ładowania.
