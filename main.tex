...
% TODO
% dane autora
\newcommand{\FirstNameAuthor}{Patryk}
\newcommand{\SurnameAuthor}{Sroczyński}
\newcommand{\IdAuthor}{297091}   % numer albumu  (bez $\langle$ i $\rangle$)
...
\newcommand{\FirstNameCoauthor}{Arkadiusz} % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\SurnameCoauthor}{Stencel}   % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\IdCoauthor}{297094}

\newcommand{\DFirstNameCoauthor}{Dawid} % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\DSurnameCoauthor}{Strzyż}   % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\DIdCoauthor}{299852}

\newcommand{\MFirstNameCoauthor}{Mariusz} % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\MSurnameCoauthor}{Wróbel}   % Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
\newcommand{\MIdCoauthor}{297106}% Jeżeli praca ma tylko jednego autora, to dane drugiego autora zostają puste.
%%%%%%%%%%

\newcommand{\Supervisor}{dr inż. Rafał Brociek}     % dane promotora (bez $\langle$ i $\rangle$)
\newcommand{\Title}{Postcardia - aplikacja społecznościowa.}           % tytuł pracy po polsku
...
\newcommand{\Specialisation}{Programowanie aplikacji mobilnych}     % specjalność  (bez $\langle$ i $\rangle$)
...
\newcommand{\printCoauthor}{%		
    ...
    \StrLen{\DFirstNameCoauthor}[\FNCoALen]
    \ifthenelse{\FNCoALen > 0}%
    {%
		{\large\bfseries\DCoauthor\par}
	
		{\normalsize\bfseries \LeftId: \DIdCoauthor\par}
    }%
    {}

    \StrLen{\MFirstNameCoauthor}[\FNCoALen]
    \ifthenelse{\FNCoALen > 0}%
    {%
		{\large\bfseries\MCoauthor\par}
	
		{\normalsize\bfseries \LeftId: \MIdCoauthor\par}
    }%
    {}
} 
...
\newcommand{\autor}{%		
    ...
    {\FirstNameAuthor\ \SurnameAuthor, \FirstNameCoauthor\ \SurnameCoauthor, \DFirstNameCoauthor\ \DSurnameCoauthor , \MFirstNameCoauthor\ \MSurnameCoauthor}%
...
\ifthenelse{\FNCoALen > 0}%
{%
\author{\FirstNameAuthor\ \SurnameAuthor, \FirstNameCoauthor\ \SurnameCoauthor, \DFirstNameCoauthor\ \DSurnameCoauthor , \MFirstNameCoauthor\ \MSurnameCoauthor}
}%
{%
...
\newcommand{\DCoauthor}{\DFirstNameCoauthor\ \MakeUppercase{\DSurnameCoauthor}}
\newcommand{\MCoauthor}{\MFirstNameCoauthor\ \MakeUppercase{\MSurnameCoauthor}}
\newcommand{\Type}{PROJEKT INŻYNIERSKI}
\newcommand{\Faculty}{Katedra
 Zastosowań Matematyki i Metod Sztucznej Inteligencji} 
...
%, a zarazem przesłać pozdrowienia dla bliskich osób, przykładowo z słonecznego Bałtyku.
