...
\section{Biblioteki}
W rozdziale tym zostaną omówione biblioteki użyte w projekcie. Na początku omówimy główne biblioteki każdego modułu na których podstawie zostały stworzone. W dalszych podrozdziałach omówimy biblioteki dodatkowe które wchodzą w skład modułów dodając do nich nowe funkcjonalności lub rozwijając już te istniejące.
...
\begin{itemize}
    ...
    \item privider - jest to biblioteka do zarządzania stanem aplikacji. Umożliwia na przebudowanie widoku gdy Consumer wykryje zmianę wartości zmiennej.
\end{itemize}
