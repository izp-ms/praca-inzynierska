...
Aplikacje społecznościowe są czymś co jest w naszym świecie już czymś normalnym, powszechnym. Większość z nich sprowadza się do wysyłania zdjęć na swoje konto aby każdy widział co robisz i gdzie jesteś. Przed erą smartfonów takie informacje były bardziej spersonalizowane, ponieważ służyły do tego listy na których pisaliśmy co robimy, oraz pocztówki dzięki którym mogliśmy pokazać gdzie jesteśmy. Właśnie to drugie zainspirowało nas do połączenia starego z nowym, pocztówek z aplikacją społecznościową. Chcemy aby odwiedzanie różnych miejsc, czy to lokalnie, blisko, czy tych na drugim końcu świata, łączyło się z czymś kiedyś powszechnym czyli wysyłaniem pocztówek. Wszak cieszymy się bardziej z pocztówki wysłanej przez rodzinę lub przyjaciela niż ze zdjęcia na Facebooku.
...
\begin{itemize}
    ...
    \item path\_provider - biiblioteka wykorzystywana na lokalizowanie plików w systemie.
